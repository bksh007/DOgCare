...
public class ExpensesAdapter extends CursorAdapter implements StickyListHeadersAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        TextView category = (TextView) view.findViewById(R.id.tv_expense_item_category);
        TextView amount = (TextView) view.findViewById(R.id.tv_expense_item_amount);
        ...
        amount.setText("Rs." + expenseAmount.toString());
    ...
    public View getHeaderView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.expense_list_header, parent, false);
            holder.date = (TextView) convertView.findViewById(R.id.tv_listHeader_date);
            holder.total = (TextView) convertView.findViewById(R.id.tv_listHeader_total);
        ...
        holder.total.setText("Rs." + dayTotal.toString());
        return convertView;
    }
